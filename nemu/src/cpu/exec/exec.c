...
opcode_entry opcode_table [512] = {
  ...
  /* 0x24 */	IDEXW(G2E, sub, 1), IDEX(G2E, sub), IDEXW(E2G, sub, 1), IDEX(E2G, sub),
  /* 0x28 */	IDEXW(I2a, sub, 1), IDEX(I2a, sub), EMPTY, EMPTY,
  ...
  /* 0xe8 */	IDEX(J ,call), IDEX(J ,jmp), EMPTY, IDEXW(J ,jump, 1),
